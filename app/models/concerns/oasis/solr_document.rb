module Oasis
  ...
  included do
    ...
    attribute :related_materials_title, Solr::Array, solr_name('related_materials_title')
    attribute :related_materials_url, Solr::Array, solr_name('related_materials_url')
