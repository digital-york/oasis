Hyrax.config do |config|
  ...
  config.minter_statefile = Figaro.env.config.minter_statefile

  # Prefix for Redis keys
  config.redis_namespace = Figaro.env.config.redis_namespace

  # Path to the file characterization tool
  config.fits_path = Figaro.env.config.fits_path

  # Path to the file derivatives creation tool
  config.libreoffice_path = Figaro.env.config.libreoffice_path
  ...
  config.realtime_notifications = Figaro.env.config.realtime_notifications
  ...
  config.derivatives_path = Figaro.env.config.derivatives_path
